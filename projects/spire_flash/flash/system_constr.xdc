...
set_property  -dict {PACKAGE_PIN  F21  IOSTANDARD LVCMOS25} [get_ports gpio[0]];
set_property  -dict {PACKAGE_PIN  F22  IOSTANDARD LVCMOS25} [get_ports gpio[1]];
set_property  -dict {PACKAGE_PIN  H22  IOSTANDARD LVCMOS25} [get_ports gpio[2]];
set_property  -dict {PACKAGE_PIN  G22  IOSTANDARD LVCMOS25} [get_ports gpio[3]];
set_property  -dict {PACKAGE_PIN  H18  IOSTANDARD LVCMOS25} [get_ports gpio[4]];
set_property  -dict {PACKAGE_PIN  H15  IOSTANDARD LVCMOS25} [get_ports gpio[5]];
set_property  -dict {PACKAGE_PIN  J15  IOSTANDARD LVCMOS25} [get_ports gpio[6]];
set_property  -dict {PACKAGE_PIN  K15  IOSTANDARD LVCMOS25} [get_ports gpio[7]];
set_property  -dict {PACKAGE_PIN  N15  IOSTANDARD LVCMOS25} [get_ports gpio[8]];
set_property  -dict {PACKAGE_PIN  L16  IOSTANDARD LVCMOS25} [get_ports gpio[9]];
set_property  -dict {PACKAGE_PIN  M15  IOSTANDARD LVCMOS25} [get_ports gpio[10]];
set_property  -dict {PACKAGE_PIN  G17  IOSTANDARD LVCMOS25} [get_ports gpio[11]];
