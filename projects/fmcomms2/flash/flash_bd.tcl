...
#    set_property -dict [list CONFIG.PCW_GPIO_EMIO_GPIO_IO {17}] $sys_ps7
    ...
    connect_bd_net -net intc_inconst [get_bd_pins constant_0/const] [get_bd_pins sys_concat_intc/In0]
    connect_bd_net -net intc_inconst [get_bd_pins constant_0/const] [get_bd_pins sys_concat_intc/In1]
    connect_bd_net -net intc_inconst [get_bd_pins constant_0/const] [get_bd_pins sys_concat_intc/In4]

    # interconnect (cpu)
    connect_bd_intf_net -intf_net axi_cpu_interconnect_m07_axi [get_bd_intf_pins axi_cpu_interconnect/M00_AXI] [get_bd_intf_pins axi_ad9361/s_axi]
    connect_bd_intf_net -intf_net axi_cpu_interconnect_m08_axi [get_bd_intf_pins axi_cpu_interconnect/M01_AXI] [get_bd_intf_pins axi_ad9361_adc_dma/s_axi]
    connect_bd_intf_net -intf_net axi_cpu_interconnect_m09_axi [get_bd_intf_pins axi_cpu_interconnect/M02_AXI] [get_bd_intf_pins axi_ad9361_dac_dma/s_axi]
